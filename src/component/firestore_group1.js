...
function MyFireStoreApp() {
  ...
  async function PostData() {
    try {
      const docRef = await addDoc(collection(db, "group1"), {
      ...
      // const querySnapshot = await getDocs(collection(db, "group1"));
      ...
      //     created_time: new Date(doc.data().created_time.seconds * 1000),
      //   });
      // });
    } catch (e) {
